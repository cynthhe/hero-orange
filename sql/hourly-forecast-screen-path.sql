...
AND platform = "ANDROID" AND device.category <> "tablet"
...
#WHERE screen_path LIKE "hourly_details_sheet>hourly_forecast>hourly_details_sheet"
#WHERE REGEXP_CONTAINS(screen_path, r"hourly_details_sheet>hourly_forecast>hourly_details_sheet")
WHERE REGEXP_CONTAINS(screen_path, r"hourly_details_sheet>hourly_details_sheet")
ORDER BY sessions desc
